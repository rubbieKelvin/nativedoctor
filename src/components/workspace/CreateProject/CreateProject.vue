    ...
    <div class="flex h-full w-full flex-col gap-6 p-8">
        ...
        >
            <div class="flex flex-col gap-2">
                ...
                <Input id="name" v-model="name" placeholder="My API project" />
            </div>
            <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                <label for="folder" class="text-sm font-medium"> Folder </label>
            ...
            <Button type="submit" :disabled="creating || !folderPath.trim()">
